...
var PglyFinderComponent = /** @class */ (function (_super) {
    ...
    function PglyFinderComponent(el) {
        ...
        _this._search = {
            wrapper: dommanipulation_1.default.findElement(_this._wrapper, '.pgly-wps--field .pgly-wps--input'),
            input: dommanipulation_1.default.findElement(_this._wrapper, '.pgly-wps--field input'),
            button: dommanipulation_1.default.findElement(_this._wrapper, '.pgly-wps--field button'),
        };
        _this._selected = {
            wrapper: dommanipulation_1.default.findElement(_this._wrapper, '.pgly-wps--field .pgly-wps--selected'),
            label: dommanipulation_1.default.findElement(_this._wrapper, '.pgly-wps--field .pgly-wps--selected .pgly-wps--label'),
            button: dommanipulation_1.default.findElement(_this._wrapper, '.pgly-wps--field .pgly-wps--selected button'),
        };
        _this._items = {
...
exports.default = PglyFinderComponent;
