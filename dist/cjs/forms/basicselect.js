...
var PglyBasicSelectComponent = /** @class */ (function (_super) {
    ...
    function PglyBasicSelectComponent(el) {
        ...
        _this._input = dommanipulation_1.default.findElement(_this._wrapper, 'select');
    ...
    PglyBasicSelectComponent.prototype._render = function (items) {
        var _this = this;
        var placeholder = dommanipulation_1.default.findElement(this._input, '.placeholder');
...
exports.default = PglyBasicSelectComponent;
