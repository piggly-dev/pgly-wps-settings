(function (global, factory) {
    ...
    var wpSingleMediaFrame=PglySingleMediaComponent.wpFrame;var wpMultipleMediaFrame=PglyMultipleMediaComponent.wpFrame;var WPForm=function(){function t(t,o,r,e,i){var s=this;void 0===i&&(i=!1),this._rules={},this._group=!1,this._actions={};this._toaster=new PglyToast(o),this._rules=r,this._form=this._loadForm(t,null!=e?e:function(t){return s._applyData(t)},r),this._group=i;}return t.prototype.toaster=function(){return this._toaster},t.prototype.form=function(){return this._form},t.prototype.actions=function(){return this._actions},t.prototype.isOnPost=function(){var t,o=this;this._postForm=null!==(t=document.querySelector('form[name="post"]'))&&void 0!==t?t:void 0,this._postForm&&!this._group&&this._postForm.addEventListener("submit",(function(t){var r;t.preventDefault(),o._form?o._form.submit("POST",o._form.dataset().action,o._form.prepare(o._rules)):null===(r=o._postForm)||void 0===r||r.submit();}));},t.prototype._loadForm=function(t,o,r){var e=new PglyAsyncFormEngine(t,{rules:null!=r?r:{}});return e.formatter(o.bind(this)),e.on("error",this._error.bind(this)),e.on("requestSuccess",this._onSuccess.bind(this)),e.on("requestError",this._onError.bind(this)),e.auto(),e},t.prototype._applyData=function(t){if(!this._form)return t;var o=__assign({},t);return this._form.dataset().recordId&&(o.id=this._form.dataset().recordId),this._form.dataset().postId&&(o.post_id=this._form.dataset().postId),this._form.dataset().xSecurity&&(o.x_security=this._form.dataset().xSecurity),o},t.prototype._error=function(){this._toaster.launch("Campos inválidos, verifique antes de continuar",{type:"danger",timer:5e3});},t.prototype._onSuccess=function(t){var o=t.response;o.success?(this._toaster.launch(o.data.message,{type:"success",timer:5e3}),this._postForm&&this._postForm.submit(),o.data.id&&this._updateRecordId(o.data.id)):this._toaster.launch(o.data.message,{type:"danger",timer:5e3});},t.prototype._onError=function(t){var o,r,e,i,s,n=t.error;this._toaster.launch(null!==(s=null!==(i=null===(e=null===(r=null===(o=null==n?void 0:n.response)||void 0===o?void 0:o.data)||void 0===r?void 0:r.data)||void 0===e?void 0:e.message)&&void 0!==i?i:n.message)&&void 0!==s?s:"Erro de execução do script",{type:"danger",timer:5e3});},t.prototype._getRecordId=function(){if(this._form)return this._form.dataset().recordId},t.prototype._updateRecordId=function(t){t&&this._form&&(this._form.formEl().dataset.recordId=t);},t}();
