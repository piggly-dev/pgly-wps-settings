(function (global, factory) {
    ...
    var wpSingleMediaFrame=PglySingleMediaComponent.wpFrame;var wpMultipleMediaFrame=PglyMultipleMediaComponent.wpFrame;var WPForm=function(){function t(t,r,o,e,n){var i=this;void 0===n&&(n=!1),this._rules={},this._group=!1,this.actions={};this._toaster=new PglyToast(r),this._rules=o,this._form=this._loadForm(t,null!=e?e:function(t){return i._applyData(t)},o),this._group=n;}return t.prototype.toaster=function(){return this._toaster},t.prototype.form=function(){return this._form},t.prototype.isOnPost=function(){var t,r=this;this._postForm=null!==(t=document.querySelector('form[name="post"]'))&&void 0!==t?t:void 0,this._postForm&&!this._group&&this._postForm.addEventListener("submit",(function(t){var o;t.preventDefault(),r._form?r._form.submit("POST",r._form.dataset().action,r._form.prepare(r._rules)):null===(o=r._postForm)||void 0===o||o.submit();}));},t.prototype.inOnMetabox=function(t,r,o,e,n,i){var s=this,a=this._form.get(t);a.options({view:n,labels:{edit:"Editar",remove:"Remover"},rules:i}),a.asynchronous((function(){return __awaiter(s,void 0,void 0,(function(){var t,o;return __generator(this,(function(n){switch(n.label){case 0:return n.trys.push([0,2,,3]),[4,axios__default["default"].post(r,{id:this._form.dataset().postId,x_security:e})];case 1:return (t=n.sent().data).success?[2,t.data]:(this._onError({error:t.data}),[2,[]]);case 2:return o=n.sent(),this._onError({error:o}),[2,[]];case 3:return [2]}}))}))}));var u=function(t,r,o,n){return function(i){var u=i.item;"load"!==i.origin&&(console.log(u),a.loader().prepare(),new Promise((function(o,n){var i={};Object.keys(u.inputs).forEach((function(t){i[t]=u.inputs[t].value;})),axios__default["default"].post(t,__assign(__assign({id:s._form.dataset().postId,x_security:e},r),i)).then((function(t){o(t.data);})).catch((function(t){n(t);}));})).then((function(t){var e;if(!t.success)return s._onError({error:t}),void n(u);s._onSuccess({response:t}),o(u,null!==(e=r.data.id)&&void 0!==e?e:void 0);})).catch((function(t){s._onError({error:t}),n(u);})).finally((function(){return a.loader().done()})));}};a.on("loadError",(function(t){var r=t.err;s._onError({error:r});})),a.on("added",u(o,{action:"add"},(function(t,r){a.items().updateId(t.uid,parseInt(r,10));}),(function(t){a.items().remove(t.uid);}))),a.on("updated",u(o,{action:"update"},(function(){return null}),(function(){return null}))),a.on("removed",u(o,{action:"remove"},(function(){return null}),(function(){return null}))),a.on("error",this._error.bind(this));},t.prototype.enableAction=function(t,r){var o=this;this.form().formEl().addEventListener("click",(function(e){e.target&&(e.target.classList.contains("pgly-form--"+t)&&(e.preventDefault(),r(o)));}));var e=new URLSearchParams(window.location.search).get("action");t===e&&r(this);},t.prototype.getUrl=function(t,r){return t+"?action="+r},t.prototype.applyToFinder=function(t,r,o){var e=this;t.options({load:function(t){return __awaiter(e,void 0,void 0,(function(){var e,n;return __generator(this,(function(i){switch(i.label){case 0:return i.trys.push([0,2,,3]),[4,axios__default["default"].post(r,{query:t,x_security:o})];case 1:return 0===(e=i.sent().data).data.length&&this._toaster.launch("Nenhum resultado encontrado...",{type:"danger",timer:2e3}),[2,e.data];case 2:return n=i.sent(),this._onError(n),[2,[]];case 3:return [2]}}))}))},labels:{select:"Selecionar",unselect:"Remover"}});},t.prototype._loadForm=function(t,r,o){var e=new PglyAsyncFormEngine(t,{rules:null!=o?o:{}});return e.formatter(r.bind(this)),e.on("error",this._error.bind(this)),e.on("requestSuccess",this._onSuccess.bind(this)),e.on("requestError",this._onError.bind(this)),e.auto(),e},t.prototype._applyData=function(t){if(!this._form)return t;var r=__assign({},t);return this._form.dataset().recordId&&(r.id=this._form.dataset().recordId),this._form.dataset().postId&&(r.post_id=this._form.dataset().postId),this._form.dataset().xSecurity&&(r.x_security=this._form.dataset().xSecurity),r},t.prototype._error=function(){this._toaster.launch("Campos inválidos, verifique antes de continuar",{type:"danger",timer:5e3});},t.prototype._onSuccess=function(t){var r=t.response;r.success?(this._toaster.launch(r.data.message,{type:"success",timer:5e3}),this._postForm&&this._postForm.submit(),r.data.id&&this._updateRecordId(r.data.id)):this._toaster.launch(r.data.message,{type:"danger",timer:5e3});},t.prototype._onError=function(t){var r,o,e,n,i,s=t.error;this._toaster.launch(null!==(i=null!==(n=null===(e=null===(o=null===(r=null==s?void 0:s.response)||void 0===r?void 0:r.data)||void 0===o?void 0:o.data)||void 0===e?void 0:e.message)&&void 0!==n?n:s.message)&&void 0!==i?i:"Erro de execução do script",{type:"danger",timer:5e3});},t.prototype._getRecordId=function(){if(this._form)return this._form.dataset().recordId},t.prototype._updateRecordId=function(t){t&&this._form&&(this._form.formEl().dataset.recordId=t);},t}();
