(function (global, factory) {
    ...
    var PglyBasicSelectComponent=function(t){function e(e){var n=t.call(this,e)||this;return n._changeEvent=!1,n._input=DOMManipulation.findElement(n._wrapper,"select"),n._loader=new PglyLoadable(n),n._bind(),n._default(),n}return __extends(e,t),e.prototype.loader=function(){return this._loader},e.prototype.asynchronous=function(t){return __awaiter(this,void 0,void 0,(function(){var e;return __generator(this,(function(n){switch(n.label){case 0:return this.loader().prepare(),e=this._render,[4,t()];case 1:return e.apply(this,[n.sent()]),this.loader().done(),[2]}}))}))},e.prototype.emptyValue=function(){this.field().set("");},e.prototype._render=function(t){for(var e=this,n=DOMManipulation.findElement(this._input,".placeholder");this._input.firstChild;)this._input.removeChild(this._input.firstChild);n&&this._input.appendChild(n),t.forEach((function(t){var n=document.createElement("option");n.value=t.value,n.textContent=t.label,t.selected&&(n.selected=!0),e._input.appendChild(n);}));},e.prototype._bind=function(){var t=this;this.on("beforeLoad",(function(){t._input.disabled=!0;})),this.on("afterLoad",(function(){t._input.disabled=!1;})),this.on("change",(function(){t._changeEvent||(t._input.value=t.field().get());})),this._input.addEventListener("change",(function(e){t._changeEvent=!0,t._field.set(e.target.value),t._changeEvent=!1;}));},e.prototype._default=function(){this.field().set(this._input.value);},e}(PglyBaseComponent);

    var PglyGroupFormItems=function(){function t(t){this._items=[],this._parent=t;}return t.prototype.count=function(){return this._items.length},t.prototype.add=function(t){this._items.push(t),this._parent.emit("added",{item:t});},t.prototype.get=function(t){return this._items.find((function(e){return e.uid===t}))},t.prototype.all=function(){return this._items.map((function(t){var e=__assign({},t.inputs);return Object.keys(e).map((function(t){e[t]=e[t].value;})),e}))},t.prototype.update=function(t){var e=this._items.findIndex((function(t){return t.uid==t.uid}));this._items[e]=__assign(__assign({},this._items[e]),t),this._parent.emit("updated",{item:t});},t.prototype.remove=function(t){this._items=this._items.filter((function(e){return e.uid!==t})),this._parent.emit("removed",{uid:t});},t}();var PglyGroupFormComponent=function(t){function e(e){var i=t.call(this,e)||this;return i._inputs={},i._items=new PglyGroupFormItems(i),i._loader=new PglyLoadable(i),i._editing=!1,i._current=void 0,i._comps={button:DOMManipulation.findElement(i._wrapper,"button.pgly-gform--submit"),items:DOMManipulation.findElement(i._wrapper,".pgly-wps--items")},i._options={view:{},labels:{edit:"Edit",remove:"Remove"}},i._bind(),i}return __extends(e,t),e.prototype.options=function(t){this._options=__assign(__assign({},this._options),t);},e.prototype.loader=function(){return this._loader},e.prototype.add=function(t){this._inputs[t.field().name()]=t;},e.prototype.synchronous=function(t){var e=this;this.loader().prepare(),t.forEach((function(t){return e._items.add({uid:UUID.generate(),inputs:t})})),this.loader().done();},e.prototype.asynchronous=function(t){return __awaiter(this,void 0,void 0,(function(){var e=this;return __generator(this,(function(i){switch(i.label){case 0:return this.loader().prepare(),[4,t()];case 1:return i.sent().forEach((function(t){return e._items.add({uid:UUID.generate(),inputs:t})})),this.loader().done(),[2]}}))}))},e.prototype.get=function(t){return this._inputs[t]},e.prototype.remove=function(t){delete this._inputs[t];},e.prototype.auto=function(){var t=this,e="pgly-gform";this._wrapper.querySelectorAll(".pgly-gform--input").forEach((function(i){if(i.classList.contains(e+"--text")){var n=(u=new PglyInputComponent(i)).field().name();t._inputs[n]=u;}else if(i.classList.contains(e+"--textarea")){var s=(u=new PglyTextAreaComponent(i)).field().name();t._inputs[s]=u;}else if(i.classList.contains(e+"--checkbox")){var o=(u=new PglyCheckboxComponent(i)).field().name();t._inputs[o]=u;}else if(i.classList.contains(e+"--select")){var a=(u=new PglyBasicSelectComponent(i)).field().name();t._inputs[a]=u;}else if(i.classList.contains(e+"--eselect")){var r=(u=new PglySelectComponent(i)).field().name();t._inputs[r]=u;}else if(i.classList.contains(e+"--finder")){var p=(u=new PglyFinderComponent(i)).field().name();t._inputs[p]=u;}else if(i.classList.contains(e+"--single-media")){var l=(u=new PglySingleMediaComponent(i)).field().name();t._inputs[l]=u;}else if(i.classList.contains(e+"--multiple-media")){var u,d=(u=new PglyMultipleMediaComponent(i)).field().name();t._inputs[d]=u;}else;}));},e.prototype.prepare=function(t){var e=this;void 0===t&&(t={});var i={},n=[];return Object.keys(this._inputs).forEach((function(s){var o=e._inputs[s];t[o.field().name()]&&(o.validate(t[o.field().name()]),o.error().has()&&n.push({name:o.field().name(),value:o.field().get(),message:o.error().message()})),i[o.field().name()]={label:o.field().label(),value:o.field().get()};})),{inputs:i,errors:n}},e.prototype.emptyValue=function(){},e.prototype._submit=function(t){if(this._editing){if(this._current){this._items.update({uid:this._current,inputs:t.inputs});var e=DOMManipulation.findElement(this._comps.items,'.pgly-wps--card[data-uid="'+this._current+'"]');e&&e.classList.remove("pgly-wps-is-warning");}}else this._items.add({uid:UUID.generate(),inputs:t.inputs});this._editing=!1,this._current=void 0,this._flushInputs();},e.prototype._flushInputs=function(){var t=this;Object.keys(this._inputs).forEach((function(e){t._inputs[e].emptyValue();}));},e.prototype._updateInputs=function(t){var e,i=this,n=null===(e=this._items.get(t))||void 0===e?void 0:e.inputs;if(n){Object.keys(n).forEach((function(t){var e=i._inputs[t];e&&e.field().set(n[t].value,n[t].label);}));var s=DOMManipulation.findElement(this._comps.items,'.pgly-wps--card[data-uid="'+t+'"]');s&&s.classList.add("pgly-wps-is-warning");}},e.prototype._addCard=function(t){var e=this,i=document.createElement("div");i.className="pgly-wps--card pgly-wps-is-white pgly-wps-is-compact",i.dataset.uid=t.uid;var n=document.createElement("div");n.className="pgly-wps--content inside left",Object.keys(t.inputs).forEach((function(i){if(e._options.view[i]){var s=document.createElement("div");s.className="pgly-wps--item";var o=document.createElement("strong");o.textContent=e._options.view[i];var a=document.createElement("span");a.textContent=t.inputs[i].value.toString(),s.appendChild(o),s.appendChild(a),n.appendChild(s);}}));var s=document.createElement("div");s.className="pgly-wps--action-bar inside right";var o=document.createElement("button");o.className="pgly-wps--button pgly-wps-is-compact pgly-wps-is-primary pgly-wps--edit",o.dataset.uid=t.uid,o.textContent=this._options.labels.edit;var a=document.createElement("button");a.className="pgly-wps--button pgly-wps-is-compact pgly-wps-is-danger pgly-wps--remove",a.dataset.uid=t.uid,a.textContent=this._options.labels.remove,s.appendChild(o),s.appendChild(a),i.appendChild(n),i.appendChild(s),this._comps.items.appendChild(i);},e.prototype._updateCard=function(t){var e=this,i=DOMManipulation.findElement(this._comps.items,'.pgly-wps--card[data-uid="'+t.uid+'"]');if(i){var n=DOMManipulation.findElement(i,".pgly-wps--content");if(n){for(;n.firstChild;)n.removeChild(n.firstChild);Object.keys(t.inputs).forEach((function(i){if(e._options.view[i]){var s=document.createElement("div");s.className="pgly-wps--item";var o=document.createElement("strong");o.textContent=e._options.view[i];var a=document.createElement("span");a.textContent=t.inputs[i].value.toString(),s.appendChild(o),s.appendChild(a),n.appendChild(s);}}));}}},e.prototype._removeCard=function(t){var e=DOMManipulation.findElement(this._comps.items,'.pgly-wps--card[data-uid="'+t+'"]');e&&this._comps.items.removeChild(e);},e.prototype._bind=function(){var t=this;this.on("submit",(function(){var e;return t._submit(t.prepare(null!==(e=t._options.rules)&&void 0!==e?e:{}))})),this.on("added",(function(e){var i=e.item;t.field().set(t._items.all()),t._addCard(i);})),this.on("updated",(function(e){var i=e.item;t.field().set(t._items.all()),t._updateCard(i);})),this.on("removed",(function(e){var i=e.uid;t.field().set(t._items.all()),t._removeCard(i);})),this._comps.items.addEventListener("click",(function(e){var i=e.target;if(i.dataset.uid){if(e.preventDefault(),i.classList.contains("pgly-wps--edit")){if(t._editing)return;return t._editing=!0,t._current=i.dataset.uid,t._updateInputs(t._current)}if(i.classList.contains("pgly-wps--remove")){if(t._editing)return;return t._items.remove(i.dataset.uid)}}})),this._comps.button.addEventListener("click",(function(e){e.preventDefault(),t.emit("submit",{});}));},e.prototype._default=function(){this.field().set([]);},e}(PglyBaseComponent);

    var PglyBaseFormEngine=function(t){function e(e,n){var i;void 0===n&&(n={});var o=t.call(this)||this;return o._loading=!1,o._wrapper=DOMManipulation.getElement(e),o._button=DOMManipulation.findElement(o._wrapper,"button.pgly-form--submit"),o._inputs=null!==(i=n.inputs)&&void 0!==i?i:[],o._options=n,o._formatter=function(t){return qsStringify(t)},o._bind(),o}return __extends(e,t),e.prototype.formatter=function(t){this._formatter=t;},e.prototype.add=function(t){this._inputs.push(t);},e.prototype.get=function(t){return this._inputs.find((function(e){return e.field().name()===t}))},e.prototype.remove=function(t){this._inputs=this._inputs.filter((function(e){return e.field().name()!==t}));},e.prototype.auto=function(){var t=this,e="pgly-form";this._wrapper.querySelectorAll(".pgly-form--input").forEach((function(n){if(n.classList.contains(e+"--text"))t._inputs.push(new PglyInputComponent(n));else if(n.classList.contains(e+"--textarea"))t._inputs.push(new PglyTextAreaComponent(n));else if(n.classList.contains(e+"--checkbox"))t._inputs.push(new PglyCheckboxComponent(n));else if(n.classList.contains(e+"--select"))t._inputs.push(new PglyBasicSelectComponent(n));else if(n.classList.contains(e+"--eselect"))t._inputs.push(new PglySelectComponent(n));else if(n.classList.contains(e+"--finder"))t._inputs.push(new PglyFinderComponent(n));else if(n.classList.contains(e+"--single-media"))t._inputs.push(new PglySingleMediaComponent(n));else if(n.classList.contains(e+"--multiple-media"))t._inputs.push(new PglyMultipleMediaComponent(n));else if(n.classList.contains(e+"--group")){var i=new PglyGroupFormComponent(n);return i.auto(),void t._inputs.push(i)}}));},e.prototype.prepare=function(t){void 0===t&&(t={});var e={},n=[];return this._inputs.forEach((function(i){t[i.field().name()]&&(i.validate(t[i.field().name()]),i.error().has()&&n.push({name:i.field().name(),value:i.field().get(),message:i.error().message()})),e[i.field().name()]=i.field().get();})),{inputs:e,errors:n}},e.prototype.isLoading=function(){return this._loading},e.prototype.loadState=function(t){this._loading=t,this._button.classList.toggle("pgly-loading--state");},e.prototype._bind=function(){var t=this;this._wrapper.addEventListener("submit",(function(e){var n;e.preventDefault(),t.submit(t.prepare(null!==(n=t._options.rules)&&void 0!==n?n:{}));})),this._button.addEventListener("click",(function(e){var n;e.preventDefault(),t.submit(t.prepare(null!==(n=t._options.rules)&&void 0!==n?n:{}));}));},e}(EventHandler);var PglyAsyncFormEngine=function(t){function e(){return null!==t&&t.apply(this,arguments)||this}return __extends(e,t),e.prototype.submit=function(t){var e=this;if(console.table(t.inputs),!this._loading)if(0===t.errors.length){this.loadState(!0),t.inputs.xSecurity=this._options.x_security,this.emit("prepared",t);var n=this._wrapper,i=n.method,o=void 0===i?"POST":i,r=n.action;("POST"===o.toUpperCase()?axios__default["default"].post(r,this._formatter(t.inputs)):axios__default["default"].get(r,this._formatter(t.inputs))).then((function(n){e.emit("requestSuccess",{data:t.inputs,response:n.data});})).catch((function(n){e.emit("requestError",{data:t.inputs,error:n});})).finally((function(){e.loadState(!1),e.emit("requestEnd",{data:t.inputs});}));}else this.emit("error",{data:t.errors});},e}(PglyBaseFormEngine);

    var PglyNotification=function(){function t(t){this._container=DOMManipulation.getElement(t),this._bind();}return t.prototype.launch=function(t,e){var i=this,n=__assign({timer:2e3,type:"regular",light:!1},e),o=document.createElement("div");o.classList.add("pgly-wps--notification","pgly-wps-is-"+n.type),n.light&&o.classList.add("pgly-wps-is-light");var a=document.createElement("button");a.classList.add("pgly-wps--delete");var l=document.createElement("div");l.textContent=t,o.appendChild(a),o.appendChild(l),this._container.appendChild(o);var r=!1;setTimeout((function(){r||i._container.removeChild(o);}),n.timer),a.addEventListener("click",(function(){i._container.removeChild(o),r=!0;}));},t.prototype._bind=function(){document.querySelectorAll(".pgly-wps--notification .pgly-wps--delete").forEach((function(t){var e,i=t.parentNode,n=parseInt(null!==(e=i.dataset.timer)&&void 0!==e?e:"0"),o=!1;n>0&&setTimeout((function(){var t;o||null===(t=null==i?void 0:i.parentNode)||void 0===t||t.removeChild(i);}),n),t.addEventListener("click",(function(){var t;o=!0,null===(t=null==i?void 0:i.parentNode)||void 0===t||t.removeChild(i);}));}));},t}();
